...
mixin _$WeaponCsv {
  ...
  @JsonKey(ignore: true)
  $WeaponCsvCopyWith<WeaponCsv> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $WeaponCsvCopyWith<$Res> {
  factory $WeaponCsvCopyWith(WeaponCsv value, $Res Function(WeaponCsv) then) =
      _$WeaponCsvCopyWithImpl<$Res, WeaponCsv>;
  @useResult
  $Res call(
      {String name,
      String id,
...
/// @nodoc
class _$WeaponCsvCopyWithImpl<$Res, $Val extends WeaponCsv>
    implements $WeaponCsvCopyWith<$Res> {
  _$WeaponCsvCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$_WeaponCsvCopyWith<$Res> implements $WeaponCsvCopyWith<$Res> {
  factory _$$_WeaponCsvCopyWith(
          _$_WeaponCsv value, $Res Function(_$_WeaponCsv) then) =
      __$$_WeaponCsvCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String name,
...
/// @nodoc
class __$$_WeaponCsvCopyWithImpl<$Res>
    extends _$WeaponCsvCopyWithImpl<$Res, _$_WeaponCsv>
    implements _$$_WeaponCsvCopyWith<$Res> {
  __$$_WeaponCsvCopyWithImpl(
      _$_WeaponCsv _value, $Res Function(_$_WeaponCsv) _then)
      : super(_value, _then);
...
class _$_WeaponCsv implements _WeaponCsv {
  _$_WeaponCsv(
      {this.name = "",
      this.id = "",
      this.tier = "",
